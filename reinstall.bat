...
set confhome=https://raw.githubusercontent.com/dewion737-crypto/reinstall/main
set confhome_cn=https://raw.githubusercontent.com/dewion737-crypto/reinstall/main
